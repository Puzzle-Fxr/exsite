  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-20 lg:py-28">
      <div className="flex items-center gap-3">
        <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-cyan-500"><FileText size={24} /></span>
        <span className="text-xs font-semibold uppercase tracking-widest text-cyan-500">Legal</span>
      </div>
      <h1 className="mt-5 text-4xl font-bold text-slate-900">Terms of Service</h1>
      ...
      <div className="mt-12 rounded-2xl border border-blue-200 bg-blue-50 p-6">
        ...
        <p className="mt-2 text-sm text-slate-700">For any questions about these Terms, contact us:</p>
