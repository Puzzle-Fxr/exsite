    ...
    <>
      ...
      <section className="border-b border-blue-200 py-20">
        <div className="mx-auto max-w-7xl px-5">
          <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">What we build</h2>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-5">
          <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">How we deliver</h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {process.map((p) => (
              <div key={p.step} className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
                <span className="text-3xl font-bold text-blue-300">{p.step}</span>
